      ...
      <header className="home__header">
        <div className="home__brand">
          <div className="home__logo">
            <img src="/icons/app-icon-512x512.png" alt="CanvasFlow" className="home__logo-img" />
          </div>
          <div>
            <div className="home__title">CanvasFlow</div>
            <div className="home__subtitle">AI 驱动的图片创作平台</div>
          </div>
        </div>
